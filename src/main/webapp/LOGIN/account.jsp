        ...
        <div class="row">
            ...
            <div class="col-2">
                <div class="form-container">
                    ...
                    <form id="LoginForm" action="/account?action=login" method="post">
                    <p class="text-danger">${mess}</p>
                        <input type="text" name="user_name" placeholder="email">
                        <input type="password" name="passs_word" placeholder="Password">
                        <button type="submit" class="btn">Login</button>
                        <a href="">Forgot password</a>
                    </form>

                    <form id="RegForm" action="/account?action=create" method="post`">
