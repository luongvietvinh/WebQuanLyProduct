...
public class AccountDao {
    ...
    public void createAccountDao(Account account) {
        String saveproduct = "INSERT INTO account (username,passwords,email,phone,address) VALUES (?,?,?,?,?)";
        try{
    ...
    public List<Account> showListAccount() {
        String show = "select account.* , role .nameRole from account join role on account.idrole = role.idrole";
